...
namespace scrapingTemplateV51.Services
{
    public static class DomainloreService
    {
        ...
        public static async Task<List<Domain>> GetDroppedDomainsFromDomainlore()
        {
            var droppedDomainsFromDomainlore = new List<Domain>();
            ...
            do
            {
                ...
                foreach (var droppedDomain in jObject["droplist"])
                {
                    ...
                    if (domainType.Equals("1"))
                    {
                        ...
                        {
                            var da = await GetDaStatu(domainName);
                            domain.Name = domainName;
                            domain.Priority = "2";
                            domain.Type = "3";
        ...
        public static async Task<decimal> GetDaStatu(string domainName)
        {
